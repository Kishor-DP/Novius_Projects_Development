...
class OpcUaDataReceiver:
    def __init__(self, client, node_ids, train_start_nodeid, interval=1):
        ...
        self.current_train_id = None  # Add this attribute
        ...
        while self.running:
            ...
            try:
                ...
                #logger.debug("Train_Start_NodeId value: %s", train_start_value)
                  # Update current train ID
            except Exception as e:
                print("temp excep block")
                        ...
                        if len(parts) != 5:
                            ...
                            if last_insertion_time is None or (current_time - last_insertion_time) > timedelta(minutes=2):
                                try:
                                    ...
                                    EventLogger2.app_event.debug(f"_receive_data in insertintotemperature.pyTrainId:{TrainId}")
                                    self.current_train_id=TrainId
