    ...
    def _receive_data(self):
        ...
        while self.running:
            if not self.train_start_value:
                ...
                data_to_insert = None
            TrainId =  datetime.now().strftime('%Y_%m_%d_%H_%M_%S_2000') #self.current_train_id  # Use the current TrainId
                    ...
                    if isinstance(value, str):
                        ...
                        if len(parts) != 5:
                            ...
                            if TrainStart:  # Proceed if TrainStart is True
                                if last_insertion_time is None or (current_time - last_insertion_time) > timedelta(minutes=5):
                                    try:
