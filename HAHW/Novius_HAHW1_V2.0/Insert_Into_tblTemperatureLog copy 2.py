...
class TemperatureDatabase:
        ...
        while retries < max_retries:
            try:
                with open('TrainStart.json', 'r') as json_file:
                    ...
                    print("TrainStart_data:", TrainStart_data)  # Debugging line
                    self.TrainStart=TrainStart_data.get("TrainStart", False)
                    print("self.TrainStart:", self.TrainStart)  # Debugging line
    ...
    def monitor_train(self, train_id, analysis, interval=5, analysis_interval=5):
        ...
        print(f"TrainStart is.............................. False{self.TrainStart}")
        try:
            while True:
                self.read_TrainStart_Fromjson()
                if self.TrainStart==True:
...
def main():
    ...
    if train_id:
        ...
        print("Failed to read TrainId from JSON file.")
