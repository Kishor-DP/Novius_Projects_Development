...
#from Fetch_Temperaturetbl import Fetch_Temperaturetbl,TemperatureDatabase
...
class OpcUaDataReceiver:
    def __init__(self, client, node_ids, train_start_nodeid, interval=1):
        ...
        self.TrainId=train_entry_timestamp()
        print("TrainId:",self.TrainId)
    def start(self):
        ...
        print("Started Train Start Node data reception")
    ...
    def _train_start(self):
        while self.running:
            ...
            try:
                ...
                print("Train_Start_NodeId value:", train_start_value)
            except Exception as e:
                print(f"Error reading Train_Start_NodeId_Node: {e}")
                            ...
                            if self._train_start()==True:
                                if last_insertion_time is None or (current_time - last_insertion_time) > timedelta(minutes=10):
                                    try:
                                        ...
                                        data_to_insert = (self.TrainId,count, time_stamp, t1, t2, System_Timestamp)
