#insert.py
from jninsert_start_train import read_config,insert_into_start_train, establish_connection
...
def insert_into_start_train_function(Parameter):
   ...
   # Axle_Box_Cover = "Example Axle Box Cover"
    ...
    insert_into_start_train(conn, Parameter)
...
#insert_into_start_train_function(Parameter)
