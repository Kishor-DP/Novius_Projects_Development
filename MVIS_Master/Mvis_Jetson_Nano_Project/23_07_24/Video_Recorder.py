...
class VideoRecorder:
    def __init__(self):
        self.video_path = "/home/jetson/LHB.mp4"#"rtsp://admin:ntipl12345@192.168.1.108:554"#video_path
        ...
        while True:
            ...
            if motion_detected:
                ...
                if self.writer is None:
                    ...
                    now = datetime.now()
                    folder_name = f"{folder_name_as_trainid}/Train_Video"#folder_name_as_trainid
                    video_name = f"{folder_name_as_trainid}_BV_LH"
                    print(video_name)
