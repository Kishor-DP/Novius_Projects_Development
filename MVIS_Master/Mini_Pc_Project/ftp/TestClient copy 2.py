...
def upload_image_to_server(image_path, server_ip, username, password, remote_directory):
...
upload_image_to_server(image_path, server_ip, username, password, remote_directory)
