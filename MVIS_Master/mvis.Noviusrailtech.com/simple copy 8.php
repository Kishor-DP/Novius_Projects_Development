...
<div class="grid-itfst">
        ...
        <div id="textboxes112"><div class="text-below"> LH SIDE VIEW VIDEO</div><video id="video1" controls muted loop src="images/wagon.mp4" alt="Video 1">
        </div>
        <div id="textboxes111">
        ...
        <video id="video2" controls muted loop src="images/WAGAN2.mp4" alt="Video 2">
        </div>
        <div id="textboxes111">
        <div class="text-below">LH SIDE VIEW IMAGE</div>
        <img class="image-popup" id="imageaa3" src="images/wagon2.png" alt="Video 1">
          ...
          <video id="video3" controls muted loop src="images/WAGAN3.mp4" alt="Video 3">
          </div>
          <div id="textboxes111">
          ...
          <img class="image-popup" id="imageaa3" src="images/wagon3.png" alt="Video 1">
            ...
            <div id="textboxes112">
            <div class="text-below"> RH SIDE VIEW VIDEO</div>
            <video id="video4" controls muted loop src="images/WAGAN4.mp4" alt="Video 4">
            </div>
            <div id="textboxes111">
            <div class="text-below">RH SIDE VIEW IMAGE</div>
        ...
        ?>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>MP side Axle Temp</th>
                                    <th>Ap side Axle Temp</th>
                                    <th>Wheel Temp</th>
                ...
                <?php foreach ($rows as $row): ?>
                   ...
                   <tr>
                        ...
                        <td><a href="#" onclick="showImage('<?php echo 'data:image/jpeg;base64,' . base64_enCode(file_get_contents('D:/A RAIL/cloud/1/mvis.Noviusrailtech.com/ftp/pune_mum_end/detected2.jpg')); ?>')"><?php echo $row['decTs1']; ?></a></td>
                        <td><a href="#" onclick="showImage('<?php echo 'data:image/jpeg;base64,' . base64_enCode(file_get_contents('D:/A RAIL/cloud/1/mvis.Noviusrailtech.com/ftp/pune_mum_end/detected3.jpg')); ?>')"><?php echo $row['decTs2']; ?></a></td>
