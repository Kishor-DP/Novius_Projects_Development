    ...
    <div class="flex-container">
       ...
       $password = 'Yoj9IbR0y#M%';
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT * FROM Time_Stamp");
...
<td><a href="#" onclick="showImage('<?php echo 'data:image/jpeg;base64,' . base64_enCode(file_get_contents('D:/A RAIL/cloud/1/mvis.Noviusrailtech.com/ftp/pune_mum_end/detected1.jpg')); ?>')"><?php echo $row['Time']; ?></a></td>
...
<script>
       ...
       $password = 'Yoj9IbR0y#M%';
        ...
        <div id="popupContent">
            <?php if (!empty($rows)): ?>
                <?php foreach ($rows as $row): ?>
                    <p><strong>Sr_No:</strong> <?php echo $row['Sr_No']; ?></p>
                    <p><strong>Code:</strong> <?php echo $row['Code']; ?></p>
                    <p><strong>Components:</strong> <?php echo $row['Components']; ?></p>
                    <p><strong>Parameter:</strong> <?php echo $row['Parameter']; ?></p>
                    <p><strong>Alarm:</strong> <?php echo $row['Alarm']; ?></p>
                    <hr>
                <?php endforeach; ?>
            <?php endif; ?>
    ...
    function showImage(imageUrl) {
        ...
        document.querySelector('#popupContent').innerHTML = '<div class="grid-it" style="background-image: url(' + imageUrl + ');"></div>';
    }
    ...
    function showPopup(rowData) {
        ...
        for (var key in row) {
            popupContent.innerHTML += '<p><strong>' + key + ':</strong> ' + row[key] + '</p>';
        }
