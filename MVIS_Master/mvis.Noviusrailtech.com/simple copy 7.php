...
.savess {
    ...
    display: grid;
    align-items: center;
    background-image: url('images/Screenshot 2024-02-24 121218.png');
...
<div class="subbb1">
 ...
 <input type="number" id="coachInput" placeholder="Coach Number" style="height: 10px;"> 
            </div>        
</div>
...
<div class="grid-itfst">
        ...
        <div id="textboxes111"><video id="video1" autoplay muted loop src="images/wagon.mp4" alt="Video 1"></div>
        <div id="textboxes111"><img id="imageaa3" src="images/wagon.png" alt="Video 1"></div>
        <div id="textboxes111"><video id="video2" autoplay muted loop src="images/WAGAN2.mp4" alt="Video 2"></div>
        <div id="textboxes111"><img id="imageaa3" src="images/wagon2.png" alt="Video 1"></div>
          </div>
          <div class="right-column121">
          <div id="textboxes111"><video id="video3" autoplay muted loop src="images/WAGAN3.mp4" alt="Video 3"></div>
          <div id="textboxes111"><img id="imageaa3" src="images/wagon3.png" alt="Video 1"></div>
            <div id="textboxes111"><video id="video4" autoplay muted loop src="images/WAGAN4.mp4" alt="Video 4"></div>
            <div id="textboxes111"><img id="imageaa3" src="images/wagon4.png" alt="Video 1"></div>
          </div>
        </div>
...
// gridDiv.addEventListener('click', function toggleActive(element) {
